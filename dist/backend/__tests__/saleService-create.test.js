...
const testDbPath = path_1.default.join(repoRoot, "backend", "prisma", `test-saleService-create.${process.pid}.${Date.now()}.db`);
...
function prepareTestDb() {
    ...
    fs_1.default.copyFileSync(canonicalDbPath, testDbPath);
...
//# sourceMappingURL=saleService-create.test.js.map